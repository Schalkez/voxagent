...
- Usage: Reference from command with `@C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
