...
```bash
INIT=$(node "C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/bin/gsd-tools.cjs" init new-project)
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
AGENT_SKILLS_RESEARCHER=$(node "C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-project-researcher 2>/dev/null)
AGENT_SKILLS_SYNTHESIZER=$(node "C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-synthesizer 2>/dev/null)
AGENT_SKILLS_ROADMAPPER=$(node "C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-roadmapper 2>/dev/null)
```
...
```bash
mkdir -p .planning
node "C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "chore: add project config" --files .planning/config.json
```
...
```bash
mkdir -p .planning
node "C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: initialize project" --files .planning/PROJECT.md
```
...
Use template: C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
Use template: C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/templates/research-project/SUMMARY.md
...
```bash
node "C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: define v1 requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node "C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/bin/gsd-tools.cjs" generate-claude-md --output "$INSTRUCTION_FILE"
```
...
```bash
node "C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: create roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md "$INSTRUCTION_FILE"
```
...
```bash
PHASE1_SECTION=$(node "C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase 1 2>/dev/null)
