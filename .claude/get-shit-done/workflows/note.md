...
- **Global scope**: `C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/notes/`)
...
2. Glob `C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/PC/Works/Personal/test/huggingface/voxagent/.claude/notes/` — works in any directory
