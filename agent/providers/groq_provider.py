...
Groq uses an OpenAI-compatible API, so this is largely similar to the
OpenAI provider but with a different endpoint and default model.
"""
...
class GroqProvider(LLMProvider):
    ...
    def get_model_info(self) -> ModelInfo:
        """Return metadata about the Groq model."""
        return ModelInfo(name=self._model, provider="groq")
