...
import type { SkillCardProps } from '@features/skills/types';
import { PERMISSION_STYLES } from '@features/skills/constants';
    ...
    >
      <div className="p-6 flex flex-col h-full">
        <div className="flex justify-between items-start mb-4">
          ...
          <Switch checked={enabled} onChange={() => onToggle?.(!enabled)} />
        </div>
